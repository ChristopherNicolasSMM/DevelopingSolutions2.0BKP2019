class ZDSOL_CL_TREX_JSON_SERIALIZER definition
  public
  final
  create public .
...
*"* public components of class ZDSOL_CL_TREX_JSON_SERIALIZER
...
*"* do not include other source files here!!!
private section.
*"* private components of class ZDSOL_CL_TREX_JSON_SERIALIZER
*"* do not include other source files here!!!
...
CLASS ZDSOL_CL_TREX_JSON_SERIALIZER IMPLEMENTATION.
